...
<html lang="pt-br">
    <head>
        ...
        <!-- Font Awesome -->
        <link rel="stylesheet" href="<?php echo base_url("resources/site/css/font-awesome.min.css") ?>">

        <!-- Custom CSS -->
        <link rel="stylesheet" href="<?php echo base_url("resources/site/css/owl.carousel.css") ?>">
        <link rel="stylesheet" href="<?php echo base_url("resources/site/css/style.css") ?>">
        <link rel="stylesheet" href="<?php echo base_url("resources/site/css/responsive.css") ?>">
    ...
    <body>
        ...
        <div class="site-branding-area">
            <div class="container">
                <div class="row">
                    <div class="col-sm-6">
                        <div class="logo">
                            <h1><a href="#"><img src="<?php echo base_url("resources/site/img/logo.png") ?>"></a></h1>
                        </div>
                    </div>
                        ...
                        <div class="footer-menu">
                            ...
                            <ul>
                                ...
                                foreach ($categories as $value) {
                                    echo "<li><a href='".base_url("index.php/page/category/$value->idcategory")."'>$value->descategory</a></li>";
                                }
                                ?>                         
                            </ul>                        
                        </div>
        ...
        <!-- jQuery sticky menu -->
        <script src="<?php echo base_url("resources/site/js/owl.carousel.min.js") ?>"></script>
        <script src="<?php echo base_url("resources/site/js/jquery.sticky.js") ?>"></script>

        <!-- jQuery easing -->
        <script src="<?php echo base_url("resources/site/js/jquery.easing.1.3.min.js") ?>"></script>

        <!-- Main Script -->
        <script src="<?php echo base_url("resources/site/js/main.js") ?>"></script>

        <!-- Slider -->
        <script type="text/javascript" src="<?php echo base_url("resources/site/js/bxslider.min.js") ?>"></script>
        <script type="text/javascript" src="<?php echo base_url("resources/site/js/script.slider.js") ?>"></script>
    </body>
</html>
